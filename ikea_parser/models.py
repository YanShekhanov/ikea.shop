...
class Product(models.Model):
    ...
    description = models.CharField(max_length=64, blank=False, null=True, default='', verbose_name='Короткое описание')
    ...
    key_feautures = models.CharField(max_length=512, blank=True, null=True, default='', verbose_name='Основное описание')
    good_to_know = models.CharField(max_length=512, blank=True, null=True, default='', verbose_name='Полезно знать')
    care_instructions = models.CharField(max_length=512, blank=True, null=True, default='', verbose_name='Инструкция по уходу')
    materials_info = models.CharField(max_length=512, blank=True, null=True, default='', verbose_name='Материал')
